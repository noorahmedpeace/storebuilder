...
const PIC = {
  ...
  tablet: "photo-1662893170097-d6563d0093d3",
  bbq: "photo-1534177616072-ef7dc120449d",
  biryani: "photo-1589302168068-964664d93dc0",
  dessert: "photo-1588195538326-c5b1e9f80a1b",
  mensFashion: "photo-1617137968427-85924c800a22",
  kids: "photo-1525507119028-ed4c629a60a3",
  dairy: "photo-1550583724-b2692b85b150",
  drinks: "photo-1527960471264-932f39eb5846",
...
export const STARTER_TEMPLATES: StarterTemplate[] = [
  {
    ...
    layout: [
      ...
      s("t-cats", "categories", {
        ...
        c1img: img(PIC.smartphone1, 400),
        c1: "Smartphones",
        c2img: img(PIC.earbuds, 400),
        c2: "Earbuds",
        c3img: img(PIC.smartwatch, 400),
        c3: "Smartwatches",
        c4img: img(PIC.tablet, 400),
        c4: "Tablets",
        c5img: img(PIC.charger, 400),
        c5: "Chargers",
        c6img: img(PIC.phoneHand, 400),
        c6: "Accessories",
      }),
      s("t-deals", "deals", {
      ...
      s("t-prod", "products", {
        ...
        pr1img: img(PIC.smartphone1, 600),
        pr1: "Galaxy A55 5G | 99,900",
        pr2img: img(PIC.smartphone2, 600),
        pr2: "Redmi Note 13 Pro | 54,900",
        pr3img: img(PIC.earbuds, 600),
        pr3: "Wireless Earbuds | 4,500",
        pr4img: img(PIC.smartwatch, 600),
        pr4: "Smart Watch | 12,900",
      }),
      s("t-stats", "stats", {
  ...
  },
  {
    ...
    layout: [
      ...
      s("t-cats", "categories", {
        ...
        c3: "Fried Chicken",
        c4img: img(PIC.bbq, 400),
        c4: "BBQ & Karahi",
        c5img: img(PIC.biryani, 400),
        c5: "Biryani",
        c6img: img(PIC.dessert, 400),
        c6: "Desserts",
      }),
      s("t-deals", "deals", {
        title: "🔥 Hot Combos",
  ...
  },
  {
    ...
    layout: [
      ...
      s("t-cats", "categories", {
        ...
        c1: "Women",
        c2img: img(PIC.mensFashion, 400),
        c2: "Men",
        c3img: img(PIC.kids, 400),
        c3: "Kids",
      ...
      s("t-prod", "products", {
        title: "New Arrivals",
        pr1img: img(PIC.dress1, 600),
        pr1: "Summer Dress | 3,500",
        pr2img: img(PIC.shoe, 600),
        pr2: "Classic Sneakers | 6,900",
        pr3img: img(PIC.bag1, 600),
        pr3: "Leather Handbag | 8,500",
        pr4img: img(PIC.sunglasses, 600),
        pr4: "Sunglasses | 2,200",
      }),
      s("t-gallery", "gallery", {
        title: "The Lookbook",
  ...
  },
  {
    ...
    layout: [
      ...
      s("t-cats", "categories", {
        ...
        c2: "Rice & Atta",
        c3img: img(PIC.dairy, 400),
        c3: "Dairy & Eggs",
        c4img: img(PIC.oil, 400),
        c4: "Oil & Ghee",
        c5img: img(PIC.drinks, 400),
        c5: "Beverages",
        c6img: img(PIC.snacks, 400),
        c6: "Snacks",
      }),
      s("t-deals", "deals", {
        title: "🔥 Daily Deals",
      ...
      s("t-prod", "products", {
        ...
        pr1img: img(PIC.vegetables, 600),
        pr1: "Fresh Vegetable Pack | 499",
        pr2img: img(PIC.dairy, 600),
        pr2: "Milk 1.5L | 290",
        pr3img: img(PIC.drinks, 600),
        pr3: "Soft Drink 1.5L | 180",
        pr4img: img(PIC.snacks, 600),
        pr4: "Snacks Combo | 350",
      }),
      s("t-steps", "steps", {
        title: "How it works",
        s1: "Add to cart",
